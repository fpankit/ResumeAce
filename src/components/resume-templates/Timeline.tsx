...
export default function Timeline({ data, theme, style, sections }: TemplateProps) {
  ...
  return (
    <div className="space-y-12" style={s}>
      <header className="flex justify-between items-center" style={spacing}>
        <div className="w-1/2">
      ...
      {sections.experience && data.experience.length > 0 && (
        <section className="relative pl-10" style={spacing}>
